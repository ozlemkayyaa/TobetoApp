...
class IstCode extends StatelessWidget {
  const IstCode({super.key});

  @override
  Widget build(BuildContext context) {
    List<GoTrainingModel> trainingData10 = GoTrainingData.getLessons10();
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            const GoEducationHeader(title: TTexts.howEducation),
            TabBar(
